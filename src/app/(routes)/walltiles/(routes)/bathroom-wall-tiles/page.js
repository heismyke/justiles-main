...
const BathroomWallTiles = () => {
  return (
   ...
   <p className='text-lg mt-4 xl:text-xl text-[#D0C9C0] leading-[40px] xl:leading-[40px]'>Bathroom walls looking a little tired? Then why not transform your space with our amazing range of bathroom wall tiles. From trendy brick tiles to bright and bold patterns, we’ve got everything you need to make those bubble baths and shower sing-a-longs that little bit better.</p>
          </div>
          <Navigation />
    </div>
  )
