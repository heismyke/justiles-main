...
const LivingRoom = () => {
  return (
    <div className='bg-[#272727]'>
      ...
      <p className='text-lg mt-4 xl:text-lg xl:leading-[40px] text-[#D0C9C0] leading-[40px] '>If you’re updating your living room, choosing the right flooring is probably the most important decision you can make; after all, the floor sets the foundations for the rest of your space.
